...
@Named
@RequestScoped
public class Chat1Bean  implements Serializable{
    ...
    public String saveMes() throws ParseException {
        ...
        Message me=(Message)session.getAttribute("detailedMes");
        mesId.setMoutId(user.getUserId());
        mesId.setMinId(me.getId().getMoutId());
        Date date = new Date();
